...
impl PositionalEncoding {
    /// Создаем новую матрицу позиционных кодировок
    ...
    /// Применяет позиционные кодировки к матрице эмбеддингов
    ...
    /// Возвращаем часть матрицы позиционных кодировок для последовательности
